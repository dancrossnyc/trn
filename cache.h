...
void uncache_article (ARTICLE*,bool_int);
char* fetchcache (ART_NUM,int,bool_int);
char* get_cached_line (ARTICLE*,int,bool_int);
...
bool art_data (ART_NUM,ART_NUM,bool_int,bool_int);
